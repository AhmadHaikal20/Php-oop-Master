...
<head>
  ...
  <style>
    body {
        background-image: url(https://i0.wp.com/wallpapercave.com/wp/wp5384102.jpg);
...
<br>
    <div class="container">
        <div class="card shadow border-0">
            ...
            <h4 class="text-center card-header bg-success text-light text-center py-4">Input Data Warga</h4>
            ...
            <input class="btn btn-success ml-auto" type="submit" name="daftar" value="Simpan">
